...
import { ImageBackground, StyleSheet, View, Text,Image, Button, TouchableOpacity, Linking, TouchableHighlight } from 'react-native';
    ...
    return(
        <View style= {mainstyles.container}>
            ...
            <View style = {mainstyles.content}>
                <Image style = {mainstyles.image} source = {require('../assets/covid.png')}/>
